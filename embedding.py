...
def get_sentence_embeddings(text):
    # Load the specific SBERT model that matches your 12-layer, 110M parameter, 768-dim requirement
    # Note: The very first time this runs, it will download the model (approx. 400MB) from Hugging Face.
...
if __name__ == "__main__":
    # Let's test it using the cleaned string we got from your preprocessing script!
